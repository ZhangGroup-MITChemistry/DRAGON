...
class PairTanhlrCutIdeal : public Pair {
 ...
 protected:
  ...
  int nideal,nctcf,minLoopLen,maxLoopLen,ctcf_neigh,maxCTCFSep,nctcfl,nctcfr;
  double cg_factor,*scale_matrix,**ideal_potential;
  int *rawctcfList, *ctcfLoc, *rawctcfList_l, *rawctcfList_r;
  int **ctcfList;
